...
def opt_1():
    os.system('python /root/Documents/ACC_410_Exam_Calculator_Project/Chapter_6_7/insurance_and_c_and_t.py')
    return

def opt_2():
    os.system('python /root/Documents/ACC_410_Exam_Calculator_Project/Chapter_6_7/c_and_t_deduction_calc.py')
    return

def opt_3():
    os.system('python /root/Documents/ACC_410_Exam_Calculator_Project/Chapter_6_7/c_and_t_gain_loss_calc.py')
    return
